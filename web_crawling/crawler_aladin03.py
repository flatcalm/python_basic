...
# 브라우저 설정 - 일반 모드
browser = webdriver.Chrome('C:/Users/admin/Desktop/Java_Web_LKM/python/chromedriver.exe')

# 브라우저 설정 - headless 모드
# browser = webdriver.Chrome('C:/Users/admin/Desktop/Java_Web_LKM/python/chromedriver.exe', options=chrome_option)
'''
